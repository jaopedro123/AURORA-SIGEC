...
Este sistema reune, de forma organizada, tudo o que foi trabalhado na fase:
  ...
  2. Regras de decisao (logica)   -> regras booleanas R1..R5
...
Nenhuma biblioteca externa e usada: apenas Python puro.
...
subsistemas = {
    ...
    "LOG":  {"tipo": "consumo_nao_essencial", "capacidade": 5,   "prioridade": 7, "essencial": False},  # cit. secao 3.2
}
